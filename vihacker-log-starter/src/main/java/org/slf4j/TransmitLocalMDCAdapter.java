 ...
 * @date 2020-9-9
 */
public class TransmitLocalMDCAdapter implements MDCAdapter {
    ...
    private static TransmitLocalMDCAdapter mtcMDCAdapter;
    ...
    static {
        mtcMDCAdapter = new TransmitLocalMDCAdapter();
